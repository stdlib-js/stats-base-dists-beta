...
```javascript
import beta from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-beta@v0.3.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { Beta, cdf, entropy, kurtosis, logcdf, logpdf, mean, median, mgf, mode, pdf, quantile, skewness, stdev, variance } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-beta@v0.3.0-esm/index.mjs';
```
